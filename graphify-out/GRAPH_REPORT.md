# Graph Report - app-planning-bar  (2026-07-25)

## Corpus Check
- 36 files · ~154,805 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 941 nodes · 1538 edges · 64 communities (52 shown, 12 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 81 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b3260a90`
...
Cohesion: 0.09
Nodes (42): addDays(), applyVenueHours(), exportWeekCSV(), formatDateShort(), generatePrintGantt(), getMondayOf(), isToday(), loadCongesBadge() (+34 more)
...
Cohesion: 0.11
Nodes (27): allStaff, buildShiftCard(), checkAuth(), fmtH(), getActiveDate(), init(), initExtraForm(), initRevenueForm() (+19 more)
...
Cohesion: 0.22
Nodes (21): applyShiftAssignment(), applyViewMode(), assignStaffToJoker(), buildDisplayedStaff(), createShift(), decideConge(), deleteShift(), extendDisplayForRealHours() (+13 more)
...
Cohesion: 0.33
Nodes (7): _ignoreNonAffectee(), loadNonAffectees(), loadReassignBadge(), _nonAffecteesAfterRemove(), _reassignDateRange(), _recreateShiftFromDispo(), _updateReassignBadge()
...
## Knowledge Gaps
- **307 isolated node(s):** `js`, `globals`, `sharedRules`, `crypto`, `{ weekStart, currentWeekStart, WEEK_CUTOFF_HOUR }` (+302 more)
