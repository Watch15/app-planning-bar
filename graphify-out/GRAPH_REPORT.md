# Graph Report - app-planning-bar  (2026-08-12)

## Corpus Check
- 54 files · ~212,994 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1243 nodes · 1998 edges · 73 communities (63 shown, 10 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 84 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6e93500e`
...
1. `_()` - 36 edges
2. `Tests & sécurité — ouvert (revue du 2026-08-04/05)` - 33 edges
3. `m()` - 31 edges
...
- `Onglet Mon équipe (responsable)` --implements--> `planning.html (interface staff)`  [INFERRED]
  docs/prd.md → public/planning.html
- `ensureDirectorStaffProfile()` --calls--> `isValidObjectId()`  [EXTRACTED]
...
Cohesion: 0.03
Nodes (63): activeStaff, allEstablishments, allGroups, allRoles, allStaff, AUTO_COLORS, _autoScroll, _btnCopyWeek (+55 more)

### Community 5 - "Express Server & API"
Cohesion: 0.04
Nodes (27): app, bcrypt, canAccessEstablishment(), client, cors, crypto, DEPLOYED_COMMIT, DISPO_TARGET (+19 more)

### Community 6 - "Week Data Loading"
Cohesion: 0.10
Nodes (37): addDays(), exportWeekCSV(), formatDateShort(), generatePrintGantt(), getMondayOf(), isToday(), loadManagerDispos(), loadManagerTemplate() (+29 more)
...
Cohesion: 0.11
Nodes (27): buildTemplateDispos(), chargeMultiplier(), computeActiveDate(), crypto, datesCoveredByPeriods(), dispoDeadlineWaived(), disposWeekStart(), hashToken() (+19 more)

### Community 12 - "Community 12"
Cohesion: 0.10
Nodes (16): makeCollection(), makeDb(), seedKpiDb(), { app, startApp, stopApp, req }, assert, DIR, ETAB, { makeDb } (+8 more)
...
Cohesion: 0.15
Nodes (17): app, baseUrl(), startApp(), stopApp(), splitDisposByConges(), { app, startApp, stopApp, baseUrl }, assert, getJson() (+9 more)

### Community 43 - "Community 43"
Cohesion: 0.20
Nodes (7): { app, startApp, stopApp, req, baseUrl }, assert, bcrypt, EQUIPIER, { makeDb }, PATRON, { test, before, after, beforeEach }
...
Cohesion: 0.05
Nodes (42): 5 échecs au smoke `dev` — aucun n'était un bug du produit (2026-08-10), Audit complet du jeu de recette (2026-08-07), Audit Railway complet (2026-08-05) — origine, variables, secrets, Base de recette (2026-08-05), Ce qui n'a pas bougé et pèse toujours, 🔴 CI rouge depuis 3 jours, `main` non déployé — les logs HTTP cassaient le runner (2026-08-10), Colonne « Masse sal. brute » dans le tableau Performance (2026-08-07), Devant les features (+34 more)
...
Cohesion: 0.16
Nodes (14): isValidObjectId(), archivedIdsAmong(), archivedStaff(), checkDispoRappels(), cleanupOldJokers(), computeEffectiveDeadline(), connectDB(), managerOffPeriods() (+6 more)
...
## Knowledge Gaps
- **478 isolated node(s):** `js`, `globals`, `sharedRules`, `crypto`, `{ weekStart, currentWeekStart, WEEK_CUTOFF_HOUR }` (+473 more)
