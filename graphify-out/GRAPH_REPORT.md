...
## Corpus Check
- 89 files · ~354,384 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2015 nodes · 3412 edges · 131 communities (116 shown, 15 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 106 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3519e52a`
...
Cohesion: 0.03
Nodes (42): isFullRangeOnConge(), app, bcrypt, canAccessEstablishment(), canManageCloture(), client, CLIENT_PROFILE, cors (+34 more)
...
Cohesion: 0.29
Nodes (7): classifyDirectorLinks(), normName(), APPLY, CREATE, main(), { openDb }, { pickStaffColor, classifyDirectorLinks }
...
Cohesion: 0.22
Nodes (9): buildTemplateDispos(), dispoEventDelta(), appliquerCongeApprouve(), auditActor(), disposOffPeriods(), managerOffPeriods(), materializeTemplateWeek(), purgeDisposAvecTrace() (+1 more)
...
Cohesion: 0.11
Nodes (12): { app, startApp, stopApp, req }, assert, CUR, { makeDb }, N1, N2, N2mon, N5mon (+4 more)
...
Cohesion: 0.10
Nodes (32): buildPerformanceSimulation(), buildStaffRateStatsReport(), { buildTemplateDispos }, chargeMultiplier(), computeActiveDate(), crypto, datesCoveredByPeriods(), deriveStaffHourlyStat() (+24 more)
...
Cohesion: 0.09
Nodes (20): app, stopApp(), { app, startApp, stopApp, req }, assert, { makeDb }, PATRON, { test, before, after }, { app, startApp, stopApp, req } (+12 more)
...
Cohesion: 0.18
Nodes (11): archivedIdsAmong(), checkDispoRappels(), cleanupOldJokers(), computeEffectiveDeadline(), connectDB(), dispoOpenVenues(), materializeAllDispoTemplates(), scheduleDailyAt10() (+3 more)
...
Cohesion: 0.22
Nodes (9): isValidObjectId(), pickStaffColor(), archivedStaff(), canAccessWeekValidation(), createManagerStaffProfile(), ensureDirectorStaffProfile(), nouveautesUserId(), resolveStaffForPlanning() (+1 more)
...
## Knowledge Gaps
- **799 isolated node(s):** `name`, `install`, `start`, `terminals`, `ports` (+794 more)
