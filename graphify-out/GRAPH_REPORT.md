...
## Corpus Check
- 94 files · ~363,450 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2091 nodes · 3530 edges · 130 communities (116 shown, 14 thin omitted)
...
Cohesion: 0.04
Nodes (20): an(), Be(), cn(), Cs(), dA(), E(), FA(), gs() (+12 more)
...
Cohesion: 0.02
Nodes (72): addManagerOff(), allEstablishments, allGroups, allRoles, allStaff, AUTO_COLORS, _autoScroll, _btnCopyWeek (+64 more)

### Community 5 - "Express Server & API"
Cohesion: 0.03
Nodes (39): isFullRangeOnConge(), app, bcrypt, canAccessEstablishment(), canManageCloture(), client, CLIENT_PROFILE, cors (+31 more)
...
Cohesion: 0.07
Nodes (60): activeStaff, addDaysLocal(), ajusterHeureCloture(), allStaff, buildShiftCard(), canForceDeletePointageShift(), canSeeCodeCloture(), canShowPointageDelete() (+52 more)
...
Cohesion: 0.20
Nodes (10): buildRoleFilters(), loadStaffNotesList(), matchesWordPrefix(), normalizeStr(), openStaffModal(), populateStaffManageFilters(), renderCongesListPatron(), renderSidebar() (+2 more)
...
Cohesion: 0.10
Nodes (26): darken(), fromHex(), groupKey(), hashedOf(), mix(), of(), stripeBackground(), BASE (+18 more)
...
Cohesion: 0.15
Nodes (13): classifyDirectorLinks(), normName(), pickStaffColor(), APPLY, main(), { normName: norm }, { ObjectId }, { openDb } (+5 more)
...
Cohesion: 0.13
Nodes (31): applyShiftAssignment(), askConfirm(), assignStaffToJoker(), batchToast(), buildDisplayedStaff(), createShift(), _decideSwap(), deleteShift() (+23 more)
...
Cohesion: 0.12
Nodes (19): addEstablishment(), applyVenueHours(), applyViewMode(), _kpiEstabRow(), _kpiProgressBar(), loadDisposKpi(), loadEstablishments(), loadGroups() (+11 more)
...
Cohesion: 0.06
Nodes (34): BASE, check(), jar, login(), main(), ok(), req(), results (+26 more)
...
Cohesion: 0.25
Nodes (8): isValidObjectId(), archivedStaff(), canAccessWeekValidation(), createManagerStaffProfile(), ensureDirectorStaffProfile(), nouveautesUserId(), resolveStaffForPlanning(), staffHasResponsableRole()
...
Cohesion: 0.16
Nodes (15): APP_COLLECTIONS, loadEnv(), { MongoClient }, openDb(), safeUri(), INDEXES, main(), { openDb } (+7 more)
...
Cohesion: 0.33
Nodes (3): assert, ClientFeatures, { test }
...
## Knowledge Gaps
- **849 isolated node(s):** `name`, `install`, `start`, `terminals`, `ports` (+844 more)
...
- **Why does `fn()` connect `Community 78` to `html2canvas Render Engine`, `Route Tests`?**
