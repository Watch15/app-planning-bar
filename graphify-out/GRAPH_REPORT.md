...
## Corpus Check
- 88 files · ~353,055 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2006 nodes · 3397 edges · 129 communities (114 shown, 15 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 106 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ea7cc41a`
...
Cohesion: 0.14
Nodes (19): envTriState(), FEATURES, enabled(), normalizeProfile(), requireFeature(), resolveAll(), fmtClock(), fmtDurationH() (+11 more)
...
Cohesion: 0.09
Nodes (34): buildPerformanceSimulation(), buildStaffRateStatsReport(), { buildTemplateDispos }, chargeMultiplier(), computeActiveDate(), crypto, datesCoveredByPeriods(), deriveStaffHourlyStat() (+26 more)
