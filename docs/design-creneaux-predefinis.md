...
8. **Bouton patron** : barre pleine largeur `#propose-slots-bar` sous la nav semaine — visible en vue Jour **et** Semaine, ordi **et** téléphone. Pas dans l’en-tête du détail jour (trop serré, disparaissait).
