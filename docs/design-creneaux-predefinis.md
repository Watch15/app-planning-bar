...
5. **Visibilité staff** : **uniquement** après « Proposer les créneaux ». Les `slot_offer` sont alors listés même si la semaine n’est pas publiée et même si le staff n’a aucun shift. Sans ce clic, rien n’est annoncé (brouillon et Jokers ponctuels restent cachés jusqu’à publication).
