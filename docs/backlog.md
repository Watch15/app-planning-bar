...
| B2-b | **Horizon — ergonomie du patron sur les semaines lointaines** | Planning / UX | 📐 **Pas commencé.** Le moteur existe déjà (cf. note §2.4 : semaines futures non auto-publiées, copie multi-semaines, publication par semaine) — c'est de l'**ergonomie et de la visibilité**, pas un moteur à écrire. Navigation et repères sur les semaines lointaines, KPI de complétion sur une semaine non adjacente, ce que voit le staff d'une semaine future non publiée. | **Basse** — personne n'est bloqué |
...
> 2026-08-13 : 328 tests, 14 fichiers**, `npm test` vert, `eslint` 0 erreur / 13 warnings.
...
> réouverture par semaine.)
>
> **`npm run smoke` : 42 vérifications** (28 au 2026-08-05), dont 8 pour B2. ⚠️ Deux
> contrôles `§9.1` y étaient **date-dépendants** : ils supposaient la deadline franchie à
> l'heure du lancement, si bien qu'un jeudi le premier passait SANS RIEN PROUVER et le
> second tombait en accusant le code. Le bloc impose désormais sa deadline et la restaure.
> Tout bloc de smoke qui dépend d'un réglage doit faire pareil : le poser, puis le rendre.
>
