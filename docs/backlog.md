...
> 2026-08-13 : 348 tests, 15 fichiers**, `npm test` vert, `eslint` 0 erreur / 13 warnings.
...
> réouverture par semaine — et +20 F-12 dans `tests/dispo-audit.test.js`.)
>
> **`npm run smoke` : 47 vérifications** (28 au 2026-08-05), dont 8 pour B2 et 5 pour F-12.
>
