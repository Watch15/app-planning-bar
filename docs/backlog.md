...
> 2026-08-13 : 360 tests, 16 fichiers**, `npm test` vert, `eslint` 0 erreur / 13 warnings.
...
> réouverture par semaine — +22 F-12 dans `tests/dispo-audit.test.js`, +10 B2-b dans `tests/planning-publication.test.js`.)
>
