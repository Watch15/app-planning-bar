    ...
    if (completed) {
        ...
        if (joker) {
            ...
            if (fixedByG != null && !Number.isNaN(Number(fixedByG))) {
                wage = Number(fixedByG);
                rate = Number(fixedByG);
                is_fixed = true;
            } else if (hourlyByG != null && !Number.isNaN(Number(hourlyByG))) {
                wage = hours * Number(hourlyByG);
                rate = Number(hourlyByG);
            } else if (o.jokerFixed != null && !Number.isNaN(Number(o.jokerFixed))) {
